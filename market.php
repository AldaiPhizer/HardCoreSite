...
<title>HardCore Games | Mercado en linea</title>
<meta name="description" content="Compra y vende artículos" />
<meta name="keywords" content="comprar atrículos, vender artículos" />
...
<div class="products" id="market" >
		<div id="offers" style="background:url(images/backgrounds/WhiteStorm_big.png); width:1120px; height:825px" >
        	<div id="table" style="margin-left:12px" >
		  		<?php 
					if (!isset($_GET['OfferId']))
					{
						include("_includes/collectables.php");
					}else{
						if ($_GET['OfferId'] == '0'){
							include("/_includes/makeoffer.php");
						}else{
							include("_includes/seeoffer.php");
						}
					}
				?>
