...
function CalendarControl() {
  ...
  function calendarDrawTable() {
    ...
    table = table + "<tr class='calheader'><th colspan='7' style='padding: 3px;'><a href='javascript:clearCalendarControl();'>Limpiar</a> | <a href='javascript:hideCalendarControl();'>Cerrar</a></td></tr>";
    table = table + "</table>";
